...
/**
 *  Abstract superclass for any class that handles image storage on a mobile iOS device.
 *  Each image item must be associated with a unique key.
 */
@interface AbstractMobileImageStore : NSObject
