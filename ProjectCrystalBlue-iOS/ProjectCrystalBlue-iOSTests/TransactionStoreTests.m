...
- (void)testCommitInvalidSqlCommand
{
    ...
    XCTAssertTrue(transactions.count == 0ul, @"TransactionStore should be empty.");
}
...
- (void)testOptimizeTransaction
{
    ...
    XCTAssertTrue(transactions.count == 1ul, @"TransactionStore should contain 1 transaction.");
    ...
    XCTAssertNotNil(transactions, @"TransactionStore should have returned a valid transaction list.");
    XCTAssertTrue(transactions.count == 0ul, @"TransactionStore should contain 1 transaction.");
...
- (void)testGetCommitAndClearTransactions
{
    ...
    transactions = [transactionStore getAllTransactions];
    XCTAssertNotNil(transactions, @"TransactionStore should have returned a valid transaction list.");
    XCTAssertTrue(transactions.count == 0ul, @"TransactionStore should contain 2 transactions.");
