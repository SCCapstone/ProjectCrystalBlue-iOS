...
- (void)testCommitInvalidSqlCommand
{
    ...
    XCTAssertTrue([transactions count] == 0, @"TransactionStore should not contain any transactions.");
}
...
- (void)testGetCommitAndClearTransactions
{
    ...
    XCTAssertTrue([transactions count] == 3, @"TransactionStore should contain 3 transactions.");
