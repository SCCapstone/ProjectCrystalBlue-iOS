...
- (void)tearDown
{
    NSString *fileToDelete = [[LocalEncryptedCredentialsProvider sharedInstance] filepath];
...
- (void)testReadAndWriteToFile
{
    ...
    [credentialsProvider setFilepath:[documentsDirectory stringByAppendingPathComponent:@"dummy_credentials"]];
