...
- (void)testGetAllLibraryObjects
{
    ...
    XCTAssertTrue(allObjects.count == 2ul, @"All of the objects were not returned from LibraryObjectStore.");
}
...
- (void)testGetSamplesForSourceKey
{
    ...
    XCTAssertTrue(samples.count == 2ul, @"LibraryObjectStore should have returned 2 samples.");
}
...
- (void)testExecuteSqlQuery
{
    ...
    XCTAssertTrue(libraryObjects.count == 2ul, @"LibraryObjectStore should have returned 2 samples.");
    ...
    XCTAssertNotNil(libraryObjects, @"LibraryObjectStore failed to execute the query.");
    XCTAssertTrue(libraryObjects.count == 1ul, @"LibraryObjectStore should have returned 1 samples.");
...
- (void)testDeleteSourceWithSamples
{
    ...
    XCTAssertTrue(samples.count == 1ul, @"LibraryObjectStore should have returned 1 sample.");
}
